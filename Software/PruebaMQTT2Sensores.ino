...
//#define MQTT_USER "usuario1"
//#define MQTT_PASSWORD "contrasena1"
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      client.publish(MQTT_SERIAL_PUBLISH_CH_1, "00"); //client.publish("/icircuit/presence/ESP32/", "hello world");
